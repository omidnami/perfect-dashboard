...
export default function Trash() {
    ...
    useEffect(() => {
        ...
        postData(`article/page/trash?page=${page}`,null,header)
    }, [router])
    ...
    return (
        <main>
            ...
            <Container>
                <Header />
                <h1 style={{marginTop:'25px',marginBottom:'25px',maxWidth:'65%',float:'right'}}>صفحات حذف شده</h1>
                <div style={{marginTop:'25px',marginBottom:'25px',maxWidth:'40%',float:'left'}}>
                    <Button onClick={() => router.push('/article/page')} className="primary"> بازگشت به صفحات</Button>
                </div>
