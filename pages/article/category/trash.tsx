...
export default function Trash() {
    ...
    useEffect(() => {
        ...
        postData(`article/cat/trash?page=${page}`,{},header)
    }, [router])
    ...
    useEffect(() => {
         if (response?.total) {
          ...
          if (response?.status) {
            ...
            setOpen(false)
            router.push('/article/category/trash?page='+page)
          }
        ...
        <main>
            ...
            <Container>
                ...
                <div style={{marginTop:'25px',marginBottom:'25px',maxWidth:'40%',float:'left'}}>
                    <Button onClick={() => router.push('/article/category/0')} className="primary"> بازگشت به تولیدکننده</Button>
                </div>
