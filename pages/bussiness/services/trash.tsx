...
export default function Trash() {
    ...
    useEffect(() => {
      setData(null)
        ...
        postData(`service/trash/?page=${page}`,null,header)
    }, [router])
    ...
    return (
        <main>
            ...
            <Container>
                <Header />
                <h1 style={{marginTop:'25px',marginBottom:'25px',maxWidth:'65%',float:'right'}}>ذباله دان خدمات</h1>
                <div style={{marginTop:'25px',marginBottom:'25px',maxWidth:'40%',float:'left'}}>
                    <Button onClick={() => router.push('/bussiness/service')} className="primary"> بازگشت لیست خدمات</Button>
                </div>
