...
import MenuItemList from "@/Components/listItem/menuItemList";
...
import { AiFillLinkedin, AiOutlineFileSearch, AiOutlineFontSize, AiOutlineLink } from "react-icons/ai";
...
export default function MenuItem() {
    ...
    useEffect(() => {
      ...
      postData(`plugins/menu/item/select`,{parent:router.query.unique,menu:router.query.menu})
    ...
    useEffect(() => {
      ...
      if (response?.total) {
        ...
        if (selectLang) {
          ...
          router.push(`/plugins/menu/${router.query.menu}/${router.query.unique}`)
        }else {
          //update success
        }
        if (open || ldopen) {
    ...
    useEffect(() => {
      ...
      postData(`plugins/menu/item/select`,{unique:unique},header)
    },[lang])
    ...
    const onClickEditHandel = async (id:any) => {
      ...
      await postData(`plugins/menu/item/select`,{unique:id},header)
    ...
    const handleNewSubmit = async () => {
      if (selectLang) {
        ...
        await postData('plugins/menu/item/insert',{...formData,
          menu:router.query.menu,
          parent:router.query.unique
        }, header)
      }
      else {
        //update
        ...
        await postData('plugins/menu/item/update',{...formData,unique:unique,
          menu:router.query.menu,
          parent:router.query.unique
        },header)
      }
